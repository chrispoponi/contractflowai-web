...
export default function ReferralsPage() {
  ...
  const generateReferralCode = async () => {
    ...
    try {
      // Generate unique code in format CF-XXXXXX
      ...
      loadData(); // Reload to show new referral
    } catch (error) {
  ...
  const activeReferrals = referrals.filter(r => r.status === 'active' || r.status === 'converted');
  const convertedReferrals = referrals.filter(r => r.status === 'converted');

  const referralLink = referralCode ? `https://contractflowai.us/Landing?code=${referralCode}` : '';
    ...
    <div className="p-4 md:p-8">
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          ...
          <p className="text-gray-600">Invite other agents and earn free months!</p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-blue-600">{activeReferrals.length}</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-green-600">{convertedReferrals.length}</p>
                </div>
          ...
          <CardContent className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Send it to other real estate agents</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
              ...
              <div>
                <p className="font-semibold text-gray-900">They sign up & upgrade</p>
                <p className="text-sm text-gray-600">Referral becomes active when they subscribe</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-gray-900">You get 1 free month!</p>
                <p className="text-sm text-gray-600">Automatically applied to your subscription</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <Card className="shadow-lg border-2 border-[#1e3a5f]">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <p className="text-sm text-gray-600">
                Share this link with other real estate agents. When they sign up and upgrade to a paid plan, you'll earn 1 free month!
              </p>
            </CardContent>
          </Card>
        )}
